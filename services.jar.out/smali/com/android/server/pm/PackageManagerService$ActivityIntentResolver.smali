...
.method static synthetic access$1600(Lcom/android/server/pm/PackageManagerService$ActivityIntentResolver;)Ljava/util/HashMap;
    .locals 1
...
.method public final addActivity(Landroid/content/pm/PackageParser$Activity;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/android/server/pm/PackageManagerService;->access$800(Landroid/content/pm/ApplicationInfo;)Z
...
.method public queryIntent(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
    ...
    invoke-virtual {v3, p4}, Lcom/android/server/pm/UserManagerService;->exists(I)Z
    ...
    :goto_0
    invoke-super {p0, p1, p2, v3, p4}, Lcom/android/server/IntentResolver;->queryIntent(Landroid/content/Intent;Ljava/lang/String;ZI)Ljava/util/List;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/pm/PackageManagerService;->getFlagsForUid(I)I

    move-result v0

    .line 6649
    .local v0, "callingFlags":I
    ...
    .line 6653
    .local v1, "itr":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/content/pm/ResolveInfo;>;"
    :cond_2
    :goto_1
    ...
    .line 6643
    .end local v0    # "callingFlags":I
    .end local v1    # "itr":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/content/pm/ResolveInfo;>;"
